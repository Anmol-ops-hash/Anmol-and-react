...
function App() {
  ...
  useEffect(() => {
    passwordGenrerator();
  }, [length, numberAllowed, charAllowed, passwordGenrerator]);
      ...
      <div className="w-full max-w-md mx-auto shadow-md rounded-lg px-4 py-3 my-8 text-orange-500 bg-gray-500">
        ...
        <div className="flex  shadow-2xl rounded-lg overflow-hidden mb-4">
          ...
          <button
            ...
            className="outline-none bg-gray-800 text-white px-3 py-0.5 shrink-0 hover:bg-slate-500 active:bg-gray-800"
          >
            Copy
          </button>
        </div>
